...
files:=build/common.o build/luamake_strings.o build/luamake_pre_ir.o build/luamake_file.o build/luamake_builtins.o build/luamake_string_manip.o build/main.o
lua_a:=lua/liblua.a
